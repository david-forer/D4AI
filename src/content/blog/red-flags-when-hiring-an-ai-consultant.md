---
title: "Red Flags When Hiring an AI Consultant, Ranked by Severity"
seoTitle: "Red Flags When Hiring an AI Consultant – The 6 That Should End the Conversation, the 5 That Only Need a Follow-Up Question, the 5 Founders Misread, and Where in the Proposal to Find Them – Forersight"
description: "Red flags when hiring an AI consultant come in 3 tiers. Here are the 6 that disqualify, the 5 worth one question, and the 5 founders misread."
pubDate: 2026-09-23T00:00:00Z
tags: ["hiring-an-ai-consultant"]
heroImage: "/images/blog/red-flags-when-hiring-an-ai-consultant.webp"
articleType: "cluster"
---
...
**They work alone.** Team size has no relationship to outcome at this scale. A solo consultant with 20 relevant engagements will usually deliver more than an agency that assigns you a junior. The [consultant against agency question](/blog/diy-ai-vs-hiring-a-consultant) turns on what your business already has documented, not on headcount.
...
1. Deliverables named as artifacts, with dates. A document, a build, a training session, a handover pack.
2. A definition of done for each phase, in one sentence each.
3. A handover section that names what your team holds afterwards and where it lives.
4. A numbered assumptions list. Its absence means the consultant has not thought about what could make the estimate wrong.
5. The named person doing the work.
6. What is out of scope, stated explicitly.

A proposal missing 4 or more of these is a tier 1 flag on its own, whatever the sales call sounded like. The [questions to ask before hiring an AI consultant](/blog/questions-to-ask-before-hiring-an-ai-consultant) covers what to raise if the document leaves gaps.
